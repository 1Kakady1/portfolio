...
<?php if(is_front_page()){
 global $solid_option;
	...
	var fActive='';
			...
			<?php  $a=0; while ($a <count($solid_option['id_filter_class'])) {
					$buf1=$solid_option['id_filter_class'][$a];$buf2=$solid_option['id_filter_name'][$a];
			?>
				$('.<?php  echo $buf2 ?>').click(function(){filterColor('<?php echo $buf1 ?>');});
			<?php $a++; } ?>
