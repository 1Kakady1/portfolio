...
$id=$_GET['post'];
$id2=$_GET['post'];
//$array_slaider=array(get_field('sl_1'),get_field('sl_2'),get_field('sl_3'),get_field('sl_4'));
?>
	...
	<main>
			<div class="wrap write">
				...
				<?php if (have_posts ()): query_posts ('p='.$id);
					...
					<div class="left_box">
								<div id="block-for-slider">
							        <div id="viewport">
							            <ul id="slidewrapper">
							                <li class="slide"><img src="<?php echo $array_slaider[0];?>" alt="1" class="img_work"></li>
							                <li class="slide"><img src="<?php echo $array_slaider[1];?>" alt="2" class="img_work"></li>
							                <li class="slide"><img src="<?php echo $array_slaider[2];?>" class="img_work"></li>
							                <li class="slide"><img src="<?php echo $array_slaider[3];?>" class="img_work"></li>
							            </ul>
				...
				<?php  endwhile; endif; wp_reset_query(); ?>
					...
					<?php
					if (have_posts ()): query_posts ('cat=3&orderby=rand&posts_per_page=3');
					while (have_posts ()): the_post ();
			...
			<?php if (have_posts ()): query_posts ('p='.$id2);
					while (have_posts ()): the_post ();
					$array_proj_info=array(get_field('title_ex'),get_field('ex_1'),get_field('ex_2'),get_field('ex_3'),get_field('ex_4'));
					?>
					<div class="right_box">
						<div class="pr_info">
							<p class="text_title"><?php echo get_field('title_ex'); ?></p>
							<ul>
								<li>
						...
						<div class="tags">
							<h1>Tags</h1>
							<div class="list-tags">
								<ul class="main_flex flex__jcontent_start flex__align-content_center">
								<?php
						...
						<?php
							$array_img_gal=array(get_field('img_g1'),get_field('img_g2'),get_field('img_g3'),get_field('img_g4'),get_field('img_g5'),get_field('img_g6'),get_field('img_g7'),get_field('img_g8'),get_field('img_g9'),get_field('img_g10'),get_field('img_g11'),get_field('img_g12'),get_field('img_g13'),get_field('img_g14'),get_field('img_g15'),get_field('img_g16'));

							for($i=0;$i<count($array_img_gal);$i++)
							{
								if($array_img_gal[$i]=="")
								{
									break;
								} else{echo '<img src="'.$array_img_gal[$i].'" alt="img'.$i.'" class="image">';}

							}
						?>
						</div>

						<div class="proj-featur">
<?php $array_proj_li=array(get_field('title_ex2'),get_field('li_s'));
 $pieces = explode(",", $array_proj_li[1]);
  ?>
							<p><?php echo $array_proj_li[0]; ?></p>
							<ol>
							<?php foreach ($pieces as $pieces_li){

										echo '<li>'.$pieces_li.'</li>';
